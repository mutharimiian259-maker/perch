...
import { BUSINESS_INFO, NAV_LINKS, WHATSAPP_MESSAGES, getWhatsAppUrl } from '@/lib/constants';
  ...
  return (
    <motion.header
      ...
      className={`fixed left-0 right-0 top-0 z-50 transition-all duration-300 ${
        isScrolled
          ? 'bg-charcoal/95 shadow-lg backdrop-blur-sm'
          : 'bg-transparent'
      }`}
    >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="overflow-hidden bg-charcoal/95 backdrop-blur-sm md:hidden"
          >
